...
export default function HeroSlider({
    ...
    const slides = activeTabConfig
        ? allSlides.filter(cat => activeTabConfig.categoryFilter.includes(cat.name))
        : allSlides;
    ...
    return (
        <section className="container my-10 md:my-14" style={{ marginTop: 50 }} >
          <div className="mb-6 md:mb-8">
              <nav className="flex items-center gap-10 uppercase tracking-[0.08em] text-[13px]">
                  <a href="/collections/new" className="font-semibold hover:opacity-80">BỘ SƯU TẬP MỚI</a>
                  <a href="/collections/gifts" className="text-gray-500 hover:text-gray-900">QUÀ TẶNG</a>
              </nav>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
              {/* Trái */}
              <a href="/collections/best-sellers" className="group relative block overflow-hidden rounded-2xl" style={{ aspectRatio: "4 / 3" }} aria-label="Được yêu thích nhất">
                  <img
                  ...
                  <div className="absolute left-6 md:left-10 bottom-6 md:bottom-10 text-white select-none">
                      <h3 className="text-lg md:text-xl font-medium tracking-wide">ĐƯỢC YÊU THÍCH NHẤT</h3>
                      <span className="mt-2 inline-flex items-center gap-2 text-sm opacity-90 group-hover:opacity-100 transition">
                          Xem chi tiết
                          <svg width="16" height="16" viewBox="0 0 24 24" className="transition-transform group-hover:translate-x-1">
              ...
              {/* Phải */}
              <a href="/collections/gifts" className="group relative block overflow-hidden rounded-2xl" style={{ aspectRatio: "4 / 3" }} aria-label="Quà tặng">
                  <img
                  ...
                  <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-black/45 via-black/10 to-transparent" />
                  <div className="absolute left-6 md:left-10 bottom-6 md:bottom-10 text-white select-none">
                      <h3 className="text-lg md:text-xl font-medium tracking-wide">QUÀ TẶNG</h3>
                      <span className="mt-2 inline-flex items-center gap-2 text-sm opacity-90 group-hover:opacity-100 transition">
                          Xem chi tiết
                          <svg width="16" height="16" viewBox="0 0 24 24" className="transition-transform group-hover:translate-x-1">
                              <path d="M5 12h14M13 5l7 7-7 7" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
