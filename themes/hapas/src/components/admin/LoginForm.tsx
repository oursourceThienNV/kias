...
import { Area } from '@evershop/evershop/components';
import { useAppState } from '@evershop/evershop/lib/app/useAppState';
...
export default function LoginForm({ authUrl, dashboardUrl }: LoginFormProps) {
  ...
  // Get logo from themeConfig (single source of truth)
  const logoConfig = themeConfig?.logo || {};
  const { src: logoSrc, alt: logoAlt = 'HAPAS E-commerce', width = '150px', height = '50px' } = logoConfig;
    ...
    <div className="admin-login-form">
      <div className="flex items-center justify-center mb-7">
        {logoSrc ? (
          ...
          // Fallback to default EverShop logo if no themeConfig logo
          <svg
            width="60"
            height="61"
            viewBox="0 0 251 276"
